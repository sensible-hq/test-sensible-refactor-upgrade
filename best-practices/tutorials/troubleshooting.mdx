...
The Sensible app visually represents SenseML queries in rendered documents using colored symbols. For more information, see [UI guide](/layout-based-extractions/app-guide/color-coding).
