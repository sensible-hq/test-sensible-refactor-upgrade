...
| whole-document table recognition       | Avoid configuring Sensible to search a whole document for tables. Instead, configure a table stop. For examples, see any of the table [methods](/senseml-reference/concepts/table-methods).                       |
...
| LLM-based methods                               | For methods based on large language models (LLMs), see [Sensible Instruct](/llm-based-extractions/prompt-tips/index-prompt-tips)                                                                                                                                                         |
