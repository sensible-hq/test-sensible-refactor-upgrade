...
To troubleshoot extractions in API or SDK responses, you can add a verbosity level to a config. For more information, see [verbosity](/senseml-reference/config-settings/verbosity).
...
![Click to enlarge](/assets/v0/images/screenshots/line_details.png)

### Inspect SenseML

The Sensible app visually represents SenseML queries in rendered documents using colored symbols. For more information, see [UI guide](/layout-based-extractions/app-guide/color).
...
![Click to enlarge](/assets/v0/images/screenshots/linter_SenseML.png)
