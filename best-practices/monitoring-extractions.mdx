...
* [Extraction coverage](/best-practices/monitoring-extractions#extraction-coverage)
* [Most-used configurations](/best-practices/monitoring-extractions#most-used-configurations)
* [Documents extracted](/best-practices/monitoring-extractions#documents-extracted)
...
In the preceding screenshot, the `Sept 25, 2023 7:30 PM` extraction has a coverage score of `61.1%`.
 ...
 For more information about how Sensible calculates coverage scores, see [Coverage](/senseml-reference/concepts/extraction-coverage).
