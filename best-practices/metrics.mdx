...
* [Extraction coverage](/best-practices/metrics#extraction-coverage)
* [Most-used configurations](/best-practices/metrics#most-used-configurations)
* [Documents extracted](/best-practices/metrics#documents-extracted)
...
![Click to enlarge](/assets/v0/images/final/dashboard_coverage.png)
...
![Click to enlarge](/assets/v0/images/final/dashboard_coverage_1.png)

In the preceding screenshot, the `Sept 25, 2023 7:30 PM` extraction has a coverage score of `61.1%`.

 For more information about how Sensible calculates coverage scores, see [Coverage](/senseml-reference/concepts/coverage).
...
![Click to enlarge](/assets/v0/images/final/dashboard_used_1.png)
...
![Click to enlarge](/assets/v0/images/final/dashboard_used_2.png)
...
![Click to enlarge](/assets/v0/images/final/dashboard_count.png)