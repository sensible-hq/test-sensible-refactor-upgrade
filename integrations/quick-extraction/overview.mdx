...
After you've configured extractions for your [custom documents](/welcome/getting-started) or for out-of-the-box [supported documents](/layout-based-extractions/out-of-the-box-extractions), you can upload documents to the Sensible app in bulk and download the extracted data as Excel files.
...
2. Select **Document** for single-document files or **Portfolio** for [documents bundled into a single file](/layout-based-extractions/multi-document-extractions).
...
**Note** Each downloaded Excel file contains the data from one document. To combine extracted documents into one Excel file, use the [Sensible API](/reference/get-excel-extraction) or [Sensible SDKs](/integrations/sdk-guides).
...
For more information about how Sensible converts JSON document extractions to Excel, see [SenseML to spreadsheet reference](/integrations/quick-extraction/senseml-to-spreadsheet-reference).