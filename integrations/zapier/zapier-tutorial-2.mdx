...
![Click to enlarge](/assets/v0/images/final/zapier_action_3.png)
4. Verify the extractions show up in your optionally configured logs:  
![Click to enlarge](/assets/v0/images/final/zapier_action_4.png)
