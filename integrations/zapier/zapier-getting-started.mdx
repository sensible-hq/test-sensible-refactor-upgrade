...
Then send the extraction to the destination of your choice with a Sensible action. For more information, see [Advanced Zapier tutorial](/integrations/zapier/zapier-tutorial-2).![Click to enlarge](/images/zapier_action.png)
