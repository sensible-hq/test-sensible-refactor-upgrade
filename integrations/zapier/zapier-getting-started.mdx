...
![Click to enlarge](/assets/v0/images/screenshots/zapier_0.png)

### Create an example Sensible extraction

To configure Zapier, you'll use a recent example of a document extraction. Follow the steps in [Getting started with out-of-the-box extractions](/layout-based-extractions/library-quickstart) to create a JSON extraction from an example 1040 tax form. 
...
![Click to enlarge](/assets/v0/images/screenshots/zapier_7.png)
...
4. In the **Set up trigger** section, select the **tax\_forms** document type you created in the previous steps, select the **Production** environment, and select the **Complete** status.

![Click to enlarge](/assets/v0/images/screenshots/zapier_1.png)
...
![Click to enlarge](/assets/v0/images/screenshots/zapier_2.png)
...
![Click to enlarge](/assets/v0/images/screenshots/zapier_3.png)

8. (Optional) If you created extra fields in the database, map each one.
9. Follow the prompts to test the action. You should see the extracted data from the [1040 example document](https://github.com/sensible-hq/sensible-configuration-library/raw/main/tax%5Fforms/1040/2021/1040%5F2021%5Fsample.pdf) as a row in Airtable:

![Click to enlarge](/assets/v0/images/screenshots/zapier_4.png)

10. Follow the prompts to publish your Zap.
...
![Click to enlarge](/assets/v0/images/screenshots/zapier_5.png)
...
Then send the extraction to the destination of your choice with a Sensible action. For more information, see [Advanced Zapier tutorial](/integrations/zapier/zapier-tutorial-2).![Click to enlarge](/assets/v0/images/screenshots/zapier_action.png)
