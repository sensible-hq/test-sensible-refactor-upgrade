...
![Click to enlarge](/assets/v0/images/screenshots/zapier_6.png)
...
![Click to enlarge](/assets/v0/images/screenshots/zapier_trigger.png)

For more information, see the [Zapier getting started guide](/integrations/zapier/zapier-getting-started).
...
![Click to enlarge](/assets/v0/images/screenshots/zapier_action.png)

For more information, see [Advanced Zapier tutorial](/integrations/zapier/zapier-tutorial-2).