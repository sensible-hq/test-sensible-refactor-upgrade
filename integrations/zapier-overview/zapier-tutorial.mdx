...
To configure Zapier, you'll use a recent example of a document extraction. Follow the steps in [Getting started with out-of-the-box extractions](/layout-based-extractions/out-of-the-box-extractions) to create a JSON extraction from an example 1040 tax form. 
...
Then send the extraction to the destination of your choice with a Sensible action. For more information, see [Advanced Zapier tutorial](/integrations/zapier-overview/advanced-zapier-tutorial-tutorial-2).![Click to enlarge](/images/zapier_action.png)
