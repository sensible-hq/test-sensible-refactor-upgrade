...
We've updated the large language model (LLM) that powers the [Query](/docs/query)
 and [Summarizer](/docs/summarizer)
...
Sensible has improved [confidence signals](/docs/confidence)
...
Sensible uses LLMs to create the fields with the [Query method](/docs/query)
...
With the new Page Range parameter for [LLM-based](/docs/instruct)
...
For more information about this example, see the [Add computed fields topic](/docs/add-computed-fields#examples)
.