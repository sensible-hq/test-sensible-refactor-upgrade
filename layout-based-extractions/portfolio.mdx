...
The config is the same as the one used in the [Getting started with layout-based extractions](/welcome/getting-started-ai), with the addition of the following fingerprint:
...
The config is the same as the one used in the [Sections](/senseml-reference/sections/index-sections) topic, with the addition of the following fingerprint:
