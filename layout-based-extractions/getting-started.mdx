...
![Click to enlarge](/assets/v0/images/final/quickstart_doc_type.png)
...
| Example document | [Download link](https://github.com/sensible-hq/sensible-docs/raw/main/readme-sync/assets/v0/pdfs/auto%5Finsurance%5Fanyco.pdf) |  
   ...
   ![Click to enlarge](/assets/v0/images/final/quickstart_upload_doc.png)  
...
![Click to enlarge](/assets/v0/images/final/quickstart_blank_config.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_after_paste.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_question.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_label_right.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_concept_1.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_concept_2.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_row.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_concept_3.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_box.png)
...
```
![Click to enlarge](/assets/v0/images/final/quickstart_error_1.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_error_3.png)

Let's double check that this region also works with the first document:

![Click to enlarge](/assets/v0/images/final/quickstart_error_4.png)
...
1. Click **Publish configuration**. The config is still a work in progress, so click **Development**. Now you can use the query parameter `env=development` to test the integration before you go to production:![Click to enlarge](/assets/v0/images/final/quickstart_publish_config.png).
...
```
![Click to enlarge](/assets/v0/images/final/quickstart_validation.png)
