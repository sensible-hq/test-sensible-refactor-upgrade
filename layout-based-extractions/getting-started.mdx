...
```
5. To test the validations with a document that's missing information, [try out an API call](/api/api-tutorial/api-tutorial-async-1) with the following example document that has these errors:  
