...
| symbol                                                          | represents                           |
| --------------------------------------------------------------- | ------------------------------------ |
| [Yellow box](/layout-based-extractions/app-guide/color-coding#yellow-box)                            | anchor                               |
| [Blue box](/layout-based-extractions/app-guide/color-coding#blue-box)                                | captured method data                 |
| [Green box](/layout-based-extractions/app-guide/color-coding#green-box)                              | box, region, table, or chunk         |
| [Green point](/layout-based-extractions/app-guide/color-coding#green-point)                          | starting point for recognizing a box |
| [Green brackets or yellow brackets](/layout-based-extractions/app-guide/color-coding#green-brackets) | ranges for sections                  |
| [Dotted blue box](/layout-based-extractions/app-guide/color-coding#dotted-blue-box)                  | discarded method data                |
| [Dotted yellow box](/layout-based-extractions/app-guide/color-coding#dotted-yellow-box)              | discarded anchor data                |
| [Pink box](/layout-based-extractions/app-guide/color-coding#pink-box)                                | fingerprint                          |
| [Purple box](/layout-based-extractions/app-guide/color-coding#purple-box)                            | line details                         |

## Yellow box

**_Yellow boxes_** represent anchors. For more information about anchors, see [Anchors](/senseml-reference/field-query-object/anchor-object).
...
**_Blue boxes_** represent method output. For more information about method, see [Method object](/senseml-reference/field-query-object/method-object). 
...
**_Green boxes_** represent boxes, regions, tables, or [chunks](/llm-based-extractions/advanced-prompt-configuration).
