...
<Steps>
  <Step title="Click the Configuration library tab, and search for your document type: ">
    ![Click to enlarge](/assets/v0/images/screenshots/library_1.png)
  </Step>
  ...
  <Step title="Click Clone to account.">
    ...
    ![Click to enlarge](/assets/v0/images/screenshots/library_2.png)  
    </Step>
    <Step title="Test the document type">
    For example, using the [Extract](/integrations/quick-extraction/index-quick-extraction) tab.
  </Step>
</Steps>
