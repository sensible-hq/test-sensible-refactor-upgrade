...
* For more information about how to write descriptions, or "prompts", see [Query Group](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/query-group-extraction-tips).
...
For the full reference for this method in SenseML, see [NLP Table](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/nlp-table).