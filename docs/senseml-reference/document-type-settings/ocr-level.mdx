...
Sensible handles OCR for documents automatically, except for advanced cases. This topic covers advanced cases. For information about additional OCR options, see [OCR](https://sensible-87.mintlify.app/senseml-reference/concepts/ocr).
...
**Note:** Set this parameter in the [Sensible API](https://sensible-87.mintlify.app/api-reference/configuration/document-type/create-document-type).
