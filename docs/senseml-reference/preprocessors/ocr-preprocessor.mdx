...
When you [extract document data with Sensible](https://sensible-87.mintlify.app/welcome/getting-started), Sensible automatically OCRs the document for you, except in advanced cases. This topic covers advanced cases. For information about additional OCR options, see [OCR](https://sensible-87.mintlify.app/senseml-reference/concepts/ocr).
...
| engine                                                             | See [OCR engine](https://sensible-87.mintlify.app/senseml-reference/document-type-settings/ocr-engine). |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
