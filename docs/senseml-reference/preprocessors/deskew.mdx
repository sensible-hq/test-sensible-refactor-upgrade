...
[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/preprocessors/deskew#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/preprocessors/deskew#examples)  
[**Notes**](https://sensible-87.mintlify.app/senseml-reference/preprocessors/deskew#notes)
...
For more information about choosing points, see [Best Practices](https://sensible-87.mintlify.app/senseml-reference/preprocessors/deskew#best-practices).
...
| rotation                                                                                                                                                   | Rotate Page  | If a document contains pages that are rotated but otherwise untransformed, in most cases you don't need a preprocessor. Sensible corrects rotation automatically. If it doesn't, configure the [Rotate Page](https://sensible-87.mintlify.app/senseml-reference/preprocessors/rotate-page) preprocessor. |
| scale                                                                                                                                                      | Scale        | If pages are affected by scale but not by affine transformations, use the [Scale](https://sensible-87.mintlify.app/senseml-reference/preprocessors/scale) preprocessor as an easier-to-configure and more robust alternative to the Deskew preprocessor.                                                 |
