...
* (Default) Sensible searches for repeated text at the top of the page. For more information about automatic recognition, see [Notes](https://sensible-87.mintlify.app/senseml-reference/preprocessors/remove-header#notes).
...
| match               | [Match](https://sensible-87.mintlify.app/senseml-reference/field-query-object/match-object) object or array of Match objects | Bypasses automatic header recognition.Removes all text on the page above the top boundary of the matched line.If Sensible doesn't find the match, it doesn't perform header removal.                                                                                                                                          |
...
![Click to enlarge](/images/remove_header_1.png)

![Click to enlarge](/images/remove_header_2.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/remove%5Fheader.pdf) |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------- |
