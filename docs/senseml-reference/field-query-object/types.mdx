...
Filter and format extracted data using the Type parameter in a [Field object](https://sensible-87.mintlify.app/senseml-reference/field-query-object/overview). 
...
[Address](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#address)  
[Boolean](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#boolean)  
[Compose](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#compose)  
[Currency](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#currency)  
[Custom](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#custom)  
[Date](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#date)  
[Distance](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#distance)  
[Images](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#images)  
[Name](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#name)  
[Number](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#number)  
[Paragraph](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#paragraph)  
[Percentage](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#percentage)  
[Phone Number](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#phone-number)  
[String](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#string)  
[Table](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#table)  
[Weight](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#weight)  
[Deprecated types](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#deprecated-types)
...
![Click to enlarge](/images/type_address_block.png)
...
![Click to enlarge](/images/type_address_paragraph.png)
...
* As a more syntactically concise alternative to the [Regex](https://sensible-87.mintlify.app/senseml-reference/methods/regex) method or to [Computed Field methods](https://sensible-87.mintlify.app/senseml-reference/computed-field-methods/overview). For example, you can write a field to capture a date-typed field, then transform the field's output with the [Split](https://sensible-87.mintlify.app/senseml-reference/computed-field-methods/split) method. Or, see the following example to transform dates using the Compose type.
* To transform table cell contents. As an alternative, see the [NLP table](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/nlp-table) method to transform table cell contents using large language models(LLMs).
...
![Click to enlarge](/images/compose_type.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/compose%5Ftype.pdf) |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------- |
...
Use this solely with the [Document Range](https://sensible-87.mintlify.app/senseml-reference/methods/document-range) method to return image metadata.
...
Use with methods that return paragraphs, for example [Document Range](https://sensible-87.mintlify.app/senseml-reference/methods/document-range) or [Paragraph](https://sensible-87.mintlify.app/senseml-reference/methods/paragraph), to format the extracted text. By default, returns paragraphs formatted with newline characters (\\n), instead of formatted as a single string.
...
![Click to enlarge](/images/annotate_superscript_and_subscript.png) 
...
```
This type does _not_ recognize country calling codes formatted with 00, for example, 0091 or 001\. 
...
Required when you define a [table method](https://sensible-87.mintlify.app/senseml-reference/concepts/choosing-a-table-method).

## Weight

Returns pounds and kilograms. Recognizes digits in USA decimal notation (for example, 1,500.06):

* digits are in the format recognized by the [Number](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#number) type
...
**Deprecated**. See [Currency](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types#currency)
