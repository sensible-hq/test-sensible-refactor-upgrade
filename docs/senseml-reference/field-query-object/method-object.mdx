...
For a list of methods, see [Methods](https://sensible-87.mintlify.app/senseml-reference/methods/overview). 

[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object#examples)
...
| --------------------------- | -----------------------------------------------------------------------------------------------------------  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| id                          | see [Methods](https://sensible-87.mintlify.app/senseml-reference/methods/overview) and [LLM-based methods](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/overview).                               | see [Methods](https://sensible-87.mintlify.app/senseml-reference/methods/overview) and [LLM-based methods](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/overview).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| tiebreaker                  | integer (zero-based index) orordinal (first, second, third, last)or  comparison (\>, \<)orjoin Default: join | If the method returns multiple elements (for example, a Row method), specifies which element to extract in the returned array. **integer**: Returns the zero-indexed nth element in the returned lines array, using Sensible's [default line sorting](https://sensible-87.mintlify.app/senseml-reference/concepts/lines#line-sorting). For example, 0 returns the first line, -1 returns the last line, and -2 returns the second-to-last line in the array.**ordinal:** Returns the first, second,third or last element, using Sensible's [default line sorting](https://sensible-87.mintlify.app/senseml-reference/concepts/lines#line-sorting).**comparison:** Returns the first or last element, sorted [alphanumerically](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#relational%5Foperators) using Unicode values. If you want to compare numeric amounts and ignore non-numbers, then add a numeric [type](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types) such as type: currency as a top-level parameter to the field.**join**: Returns all elements in the returned array as a single string, delimited by whitespaces. |
...
In the following example, the handwritten text "Nash" is slightly taller than the text "Steve", so Sensible interprets "Nash" as _preceding_ "Steve" (reversing the order interpreted by a human reader) and outputs `"Nash Steve"` as the name:

![Click to enlarge](/images/xmajor_sort_1.png)
...
![Click to enlarge](/images/sort_lines_2.png)
...
![Click to enlarge](/images/merge_lines_ocr_1.png)
...
![Click to enlarge](/images/types_filter.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/types%5Ffilter.pdf) |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------- |
...
![Click to enlarge](/images/xrange_filter.png)
...
| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/xrange%5Ffilter.pdf) |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------- |
