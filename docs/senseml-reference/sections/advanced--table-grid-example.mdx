...
* Ignoring repeated multiple anchor matches. For more information, see [Multiple anchors in section](https://sensible-87.mintlify.app/senseml-reference/concepts/section-nuances#multiple-anchors-in-section).

### Overview

To give a broad overview of using vertical sections for a table grid, see the following image:

![Click to enlarge](/images/vertical_sections_table_grid.png)
...
![Click to enlarge](/images/vertical_section_table_grid_1.png)
