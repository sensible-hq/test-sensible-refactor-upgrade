...
![Click to enlarge](/images/copy_from_sections_2.png)

If you [zip the child sections together](https://sensible-87.mintlify.app/senseml-reference/sections/advanced--zip-sections), you can output something like the following example output, and then clean it up with the Copy From Sections method. 
...
![Click to enlarge](/images/copy_from_sections.png)
