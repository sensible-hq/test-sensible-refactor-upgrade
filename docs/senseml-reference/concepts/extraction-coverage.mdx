...
**Note:** If you're familiar with extraction coverage, this detailed topic is for you. If you're new to Sensible, see [Monitoring extractions](https://sensible-87.mintlify.app/best-practices/monitoring-extractions).
...
* `validation penalties` \= sum of [validation](https://sensible-87.mintlify.app/best-practices/validating-extractions) errors and warnings. Errors are 1 penalty point and warnings are 0.5 points.
...
* Sensible includes fields output in [sections](https://sensible-87.mintlify.app/senseml-reference/sections/overview) when calculating the coverage.
