...
**Note:** If you're familiar with Sensible, this detailed topic is for you. If you're new to Sensible, see [anchor](https://sensible-87.mintlify.app/senseml-reference/field-query-object/anchor-object).

[anchor syntax](https://sensible-87.mintlify.app/senseml-reference/concepts/anchor-nuances#anchor-syntax)

[methods-filter-anchors](https://sensible-87.mintlify.app/senseml-reference/concepts/anchor-nuances#methods-filter-anchors)
