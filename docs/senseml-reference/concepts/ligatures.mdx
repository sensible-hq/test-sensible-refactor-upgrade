...
_Ligatures_ are two or more letters joined together into a single glyph. They appear to be garbage Unicode characters in your PDF direct text extraction, for example:
...
```
To correct ligatures, use the [ligature](https://sensible-87.mintlify.app/senseml-reference/preprocessors/ligature) preprocessor.