...
**Note:** If you're familiar with Sensible, this detailed topic is for you. If you're new to Sensible, see [match](https://sensible-87.mintlify.app/senseml-reference/field-query-object/match-object).
...
* The matches specified in the array occur in the document in the same order as in the array. For more information about line ordering, see [Lines](https://sensible-87.mintlify.app/senseml-reference/concepts/lines).
