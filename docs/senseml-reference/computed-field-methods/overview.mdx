...
Computed Field methods transform the output of one or more [Field objects](https://sensible-87.mintlify.app/senseml-reference/field-query-object/overview). Common use cases for computed fields include:
...
| method (**required**) | object                   | The method describes the Computed Field method used to transform fields. This object's ID parameter specifies the method, for example, [Concatenate](https://sensible-87.mintlify.app/senseml-reference/computed-field-methods/concatenate) or [Zip](https://sensible-87.mintlify.app/senseml-reference/computed-field-methods/zip).                                                                                                                                                                                                                                                                                                    |
| type                  | string (default: string) | Specifies the type of the output value. For more information about types, see [Field query object](https://sensible-87.mintlify.app/senseml-reference/field-query-object/overview).                                                                                                                                                                                                                                                                                                                                                                   |

### Notes

See also [Advanced computed field methods](https://sensible-87.mintlify.app/senseml-reference/advanced-computed-field-methods/overview).