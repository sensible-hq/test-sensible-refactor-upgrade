...
Sensible uses a large language model (LLM) to find data in paragraphs of free text, in images, or in more structured layouts, for example key/value pairs or tables. Create a query group to extract multiple facts that share a [context](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#notes), or are co-located in the document.

For tips and troubleshooting, see [Query Group](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/query-group-extraction-tips) extraction tips.

For more information about how this method works, see [Notes](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#notes).

[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#examples)  
[**Notes**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#examples)

## Parameters

**Note:** For the full list of parameters available for this method, see [Global parameters for methods](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object#section-global-parameters-for-methods). The following table only shows parameters most relevant to or specific to this method.

**Note** You can configure some of the following parameters in both the [NLP](https://sensible-87.mintlify.app/senseml-reference/preprocessors/nlp) preprocessor and in a field's method. If you configure both, the field's parameter overrides the NLP preprocessor's parameter. For more information, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration).
...
| anchor                | The Anchor parameter is optional for fields that use this method.If you specify an anchor and leave the Multimodal Engine unconfigured or configured with "region": "automatic" then:<br/>\- Sensible ignores the anchor if it's present in the document.<br/>\- Sensible returns nulls for the fields in this query group if the anchor isn't present in the document.If you specify an anchor and configure the Multimodal Engine parameter's region manually, then Sensible creates the prompt's [context](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#notes) relative to the anchor. |                                                        |
...
| multimodalEngine       | object                                                                                              | Configure this parameter to:<br/>\- Extract data from images embedded in a document, for example, photos, charts, or illustrations.<br/>\- Troubleshoot extracting from complex text layouts, such as overlapping lines, lines between lines, and handwriting. For example, use this as an alternative to the [Signature](https://sensible-87.mintlify.app/senseml-reference/methods/signature) method, the [Nearest Checkbox](https://sensible-87.mintlify.app/senseml-reference/methods/nearest-checkbox) method, the [OCR engine](https://sensible-87.mintlify.app/senseml-reference/document-type-settings/ocr-engine), and line [preprocessors](https://sensible-87.mintlify.app/senseml-reference/preprocessors/overview).This parameter sends an image of the document region containing the target data to a multimodal LLM (GPT-4 Vision Preview), so that you can ask questions about text and non-text images. This bypasses Sensible's [OCR](https://sensible-87.mintlify.app/senseml-reference/concepts/ocr) and direct-text extraction processes for the region. Note that this option doesn't support confidence signals.This parameter has the following parameters:region: The document region to send as an image to the multimodal LLM. Configurable with the following options :<br/>\- To automatically select the [context](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group#notes) as the region, specify "region": "automatic". If you configure this option for a non-text image, then help Sensible locate the context by including queries in the group that target text near the image, or by specifying the nearby text in the Chunk Scoring Text parameter. <br/>\- To manually specify a region relative to the field's anchor, specify the region using the [Region](https://sensible-87.mintlify.app/senseml-reference/methods/region) method's parameters, for example:"region": \{ "start": "below", "width": 8, "height": 1.2, "offsetX": -2.5, "offsetY": -0.25 } |
| confidenceSignals      | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration).            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| contextDescription     | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters). |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| pageHinting            | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters). |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| chunkCount             | default: 5                                                                                          | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| chunkSize              | default: 0.5                                                                                        | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| chunkOverlapPercentage | default: 0.5                                                                                        | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| pageRange              | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters). |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
![Click to enlarge](/images/multimodal_photo.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/multimodal%5Fphoto.pdf) |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
...
The following example shows using a multimodal LLM to extract from a scanned document containing handwriting. For an alternate approach to extracting from this document, see also the [Sort Lines](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object#sort-lines-example) example.
...
![Click to enlarge](/images/multimodal.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/xmajor%5Fsort.pdf) |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------ |
...
![Click to enlarge](/images/question_2.png)
...
* Sensible creates a full prompt for the LLM (GPT-3.5 Turbo) that includes the chunks, page hinting data, and your Description parameters. For more information about the full prompt, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration).
...
![Click to enlarge](/images/location.png)
...
* Sensible searches in the source document for a line that's a fuzzy match to the response. For example, if the LLM returns `4387-09-22-33`, Sensible matches the line `Policy Number: 4387-09-22-33` in the document. Sensible implements fuzzy matching using [Levenshtien distance](https://en.wikipedia.org/wiki/Levenshtein%5Fdistance).
...
* If you prompt the LLM to reformat the source text in the document or reformat the text using a [type](https://sensible-87.mintlify.app/senseml-reference/field-query-object/types) , then Sensible can fail to find a match or can find an inaccurate match.
