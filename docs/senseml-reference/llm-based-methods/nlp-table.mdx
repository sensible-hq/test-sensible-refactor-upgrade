...
For tips on authoring this method in Sensible Instruct, see [NLP Table tips](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/nlp-table-extraction-tips).
...
* Doesn't require an [anchor](https://sensible-87.mintlify.app/senseml-reference/field-query-object/anchor-object).

**Limitations**

* Can have a moderate impact on performance. For more information, see [Optimizing extraction performance](https://sensible-87.mintlify.app/best-practices/tutorials/optimizing-extraction-performance).
...
For alternatives to this method, see [Choosing a table method](https://sensible-87.mintlify.app/senseml-reference/concepts/choosing-a-table-method). 

**How it works**

For more information about how this method works, see [Notes ](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/nlp-table#notes).

[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/nlp-table#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/nlp-table#examples)  
[**Notes**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/nlp-table#notes)
...
![Click to enlarge](/images/nlp_table.png)
