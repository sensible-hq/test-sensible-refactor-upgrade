...
For tips on authoring this method in Sensible Instruct, see [List tips](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/list-tips).
...
* For highly complex repeating layouts, such as insurance loss run documents, use the [Sections](https://sensible-87.mintlify.app/senseml-reference/sections/overview) method.
...
[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/list#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/list#examples)  
[**Notes**](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/list#notes)
...
| llmEngine                           | fast, thorough. default: fast                                                                       | Specifies the LLM model to which Sensible submits the full prompt, and affects the number of chunks that Sensible submits to the LLM.If the Fast parameter results in incomplete extractions for multi-page lists, use Thorough as an alternative.<br/>\- fast: Sensible uses a faster LLM model (GPT-3.5 Turbo) and can submit a smaller number of chunks than specified by the Chunk Count parameter.<br/>\- thorough: Sensible uses a slower LLM model (GPT-4 Turbo) and submits exactly the number of chunks specified by the Chunk Count parameter. Sensible can take several minutes to return the list. For more information, see [Notes](#notes). |
...
| chunkCount                          | 20                                                                                                  | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| chunkSize                           | 1                                                                                                   | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| chunkOverlapPercentage              | 0                                                                                                   | For information about this parameter, see [Advanced prompt configuration](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration#parameters)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
![Click to enlarge](/images/list.png)
...
1. Sensible selects a number of the top-scoring chunks:  
...
2. To avoid large language model (LLM)'s token limits, Sensible batches the chunks into groups by page numbers. Sensible batches a maxiumum of 20 page numbers. The chunks in each page group can be non-consecutive in the document.
