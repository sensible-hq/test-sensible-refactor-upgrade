...
| instructions              | string       | Prompt for the LLM, describing how to transform information from the text in the Source ID parameter.For more information about how to write prompts, see [Query Group](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/query-group-extraction-tips) tips.For an example of using this parameter, see the Examples section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
