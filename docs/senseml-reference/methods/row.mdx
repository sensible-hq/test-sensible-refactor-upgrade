...
![Click to enlarge](/images/row_align.png)

[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/methods/row#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/methods/row#examples)  
[**Notes**](https://sensible-87.mintlify.app/senseml-reference/methods/row#notes)
...
| tiebreaker        | For information about this global parameter, see [Method](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object#parameters). | For information about this global parameter, see [Method](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object#parameters). |
...
![Click to enlarge](/images/row.png)
...
* To extract an entire table, see the [table methods](https://sensible-87.mintlify.app/senseml-reference/concepts/choosing-a-table-method).
* To extract a column, see the [Column method](https://sensible-87.mintlify.app/senseml-reference/methods/column).
* In a row with optional empty cells, a tiebreaker can return lines from inconsistent columns. Use the [Intersection method](https://sensible-87.mintlify.app/senseml-reference/methods/intersection) instead.
* The Row method can't extract multiple lines in a cell. Use the [Document Range](https://sensible-87.mintlify.app/senseml-reference/methods/document-range#offset-y-parameter) or [Intersection](https://sensible-87.mintlify.app/senseml-reference/methods/intersection) methods instead.