...
[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/methods/regex#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/methods/regex#examples)  
[**Notes**](https://sensible-87.mintlify.app/senseml-reference/methods/regex#notes)
...
![Click to enlarge](/images/regex.png)
...
Alternatives to this method include the [Passthrough method](https://sensible-87.mintlify.app/senseml-reference/methods/passthrough) with a custom type. For example, for the preceding example document, the following config returns similar output:
