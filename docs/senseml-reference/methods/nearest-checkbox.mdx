...
[**Parameters**](https://sensible-87.mintlify.app/senseml-reference/methods/nearest-checkbox#parameters)  
[**Examples**](https://sensible-87.mintlify.app/senseml-reference/methods/nearest-checkbox#examples)
...
![Click to enlarge](/images/nearest_checkbox.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/nearest%5Fcheckbox.pdf) |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
