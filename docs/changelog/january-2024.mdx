...
We've updated the large language model (LLM) that powers the [Query](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group)
 and [Summarizer](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/summarizer)
...
Sensible has improved [confidence signals](https://sensible-87.mintlify.app/best-practices/qualifying-llm-accuracy)
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/final/changelog_jan2024_integration_tab.png)
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/final/changelog_jan2024_auto.png)

Sensible uses LLMs to create the fields with the [Query method](https://sensible-87.mintlify.app/senseml-reference/llm-based-methods/query-group)
...
With the new Page Range parameter for [LLM-based](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/overview)
...
For more information about this example, see the [Add computed fields topic](https://sensible-87.mintlify.app/senseml-reference/advanced-computed-field-methods/add-computed-fields#examples)
.