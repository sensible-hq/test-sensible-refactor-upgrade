...
* [Extraction coverage](https://sensible-87.mintlify.app/best-practices/monitoring-extractions#extraction-coverage)
* [Most-used configurations](https://sensible-87.mintlify.app/best-practices/monitoring-extractions#most-used-configurations)
* [Documents extracted](https://sensible-87.mintlify.app/best-practices/monitoring-extractions#documents-extracted)
...
![Click to enlarge](/images/dashboard_coverage.png)
...
In the preceding screenshot, the `Sept 25, 2023 7:30 PM` extraction has a coverage score of `61.1%`.
 ...
 For more information about how Sensible calculates coverage scores, see [Coverage](https://sensible-87.mintlify.app/senseml-reference/concepts/extraction-coverage).
...
![Click to enlarge](/images/dashboard_used_1.png)
...
![Click to enlarge](/images/dashboard_used_2.png)
...
![Click to enlarge](/images/dashboard_count.png)