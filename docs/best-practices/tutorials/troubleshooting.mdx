...
To troubleshoot extractions in API or SDK responses, you can add a verbosity level to a config. For more information, see [verbosity](https://sensible-87.mintlify.app/senseml-reference/config-settings/verbosity).
...
![Click to enlarge](/images/line_details.png)

### Inspect SenseML

The Sensible app visually represents SenseML queries in rendered documents using colored symbols. For more information, see [UI guide](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding).
...
![Click to enlarge](/images/linter_SenseML.png)
