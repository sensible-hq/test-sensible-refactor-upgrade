...
For either option, you can get the results as soon as they're ready by specifying a [webhook](https://sensible-87.mintlify.app/api/api-tutorial/try-a-webhook).
...
![Click to enlarge](/images/api_quickstart_postman_3.png)
...
![Click to enlarge](/images/api_quickstart_postman_4.png)
...
![Click to enlarge](/images/api_quickstart_no_auth.png)
...
![Click to enlarge](/images/api_quickstart_postman_headers_2.png)
...
![Click to enlarge](/images/api_quickstart_postman_200.png) 
...
* Use a webhook. See [Try a webhook](https://sensible-87.mintlify.app/api/api-tutorial/try-a-webhook).
...
--header 'Authorization: Bearer YOUR_API_KEY'
```
4. In your Postman workspace, click **Import**, select **Raw text**, paste the code sample, and follow the prompts to import to code sample.

![Click to enlarge](/images/api_quickstart_postman_2.png)
