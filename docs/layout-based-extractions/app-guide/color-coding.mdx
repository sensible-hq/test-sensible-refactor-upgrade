...
| symbol                                                          | represents                           |
| --------------------------------------------------------------- | ------------------------------------ |
| [Yellow box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#yellow-box)                            | anchor                               |
| [Blue box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#blue-box)                                | captured method data                 |
| [Green box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#green-box)                              | box, region, table, or chunk         |
| [Green point](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#green-point)                          | starting point for recognizing a box |
| [Green brackets or yellow brackets](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#green-brackets) | ranges for sections                  |
| [Dotted blue box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#dotted-blue-box)                  | discarded method data                |
| [Dotted yellow box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#dotted-yellow-box)              | discarded anchor data                |
| [Pink box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#pink-box)                                | fingerprint                          |
| [Purple box](https://sensible-87.mintlify.app/layout-based-extractions/app-guide/color-coding#purple-box)                            | line details                         |

## Yellow box

**_Yellow boxes_** represent anchors. For more information about anchors, see [Anchors](https://sensible-87.mintlify.app/senseml-reference/field-query-object/anchor-object).
...
**_Blue boxes_** represent method output. For more information about method, see [Method object](https://sensible-87.mintlify.app/senseml-reference/field-query-object/method-object). 
...
**_Green boxes_** represent boxes, regions, tables, or [chunks](https://sensible-87.mintlify.app/llm-based-extractions/advanced-prompt-configuration).
