...
![Click to enlarge](/images/zapier_6.png)
...
![Click to enlarge](/images/zapier_trigger.png)

For more information, see the [Zapier getting started guide](https://sensible-87.mintlify.app/integrations/zapier-overview/zapier-tutorial).
...
![Click to enlarge](/images/zapier_action.png)

For more information, see [Advanced Zapier tutorial](https://sensible-87.mintlify.app/integrations/zapier-overview/advanced-zapier-tutorial).