...
Follow the steps in [Getting started with out-of-the-box extractions](https://sensible-87.mintlify.app/layout-based-extractions/out-of-the-box-extractions) to configure extracting data from a 1040 tax form. 
...
![Click to enlarge](/images/zapier_action_3.png)
4. Verify the extractions show up in your optionally configured logs:  
![Click to enlarge](/images/zapier_action_4.png)
