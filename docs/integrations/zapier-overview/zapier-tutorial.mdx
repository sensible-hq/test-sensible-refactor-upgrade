...
![Click to enlarge](/images/zapier_0.png)

### Create an example Sensible extraction

To configure Zapier, you'll use a recent example of a document extraction. Follow the steps in [Getting started with out-of-the-box extractions](https://sensible-87.mintlify.app/layout-based-extractions/out-of-the-box-extractions) to create a JSON extraction from an example 1040 tax form. 
...
![Click to enlarge](/images/zapier_7.png)
...
![Click to enlarge](/images/zapier_1.png)
...
![Click to enlarge](/images/zapier_2.png)
...
![Click to enlarge](/images/zapier_3.png)
...
![Click to enlarge](/images/zapier_4.png)
...
![Click to enlarge](/images/zapier_5.png)
...
Then send the extraction to the destination of your choice with a Sensible action. For more information, see [Advanced Zapier tutorial](https://sensible-87.mintlify.app/integrations/zapier-overview/advanced-zapier-tutorial).![Click to enlarge](/images/zapier_action.png)

## Notes

**Limitations**

* You can configure single-value field output with the Sensible-Zapier integration. For multi-value output such as tables and sections, you can compile document extractions into a spreadsheet or CSV file using Sensible's API or SDKs. For more information, see [SenseML to Excel reference](https://sensible-87.mintlify.app/integrations/quick-extraction/senseml-to-spreadsheet-reference).
