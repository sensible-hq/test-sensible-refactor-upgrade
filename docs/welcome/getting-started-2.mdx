...
* [**Integrate**](https://sensible-87.mintlify.app/welcome/integrating) using Sensible's API, SDKs, quick-extract UI, or other tools
* [**Quality control**](https://sensible-87.mintlify.app/best-practices/validating-extractions) extracted data
* [**Monitor**](https://sensible-87.mintlify.app/best-practices/monitoring-extractions) extracted data in production
...
* Select a new example bank statement:  
   * If you use one of your own bank statement, ensure it's one that combines multiple accounts. Note that Sensible [supports](https://sensible-87.mintlify.app/layout-based-extractions/out-of-the-box-extractions) extracting data from a single-account bank statement, but it's outside the scope of this tutorial.  
   * If you don't have a statement on hand, you can download and then select the following example:

| Example document | [Download link](https://github.com/sensible-hq/sensible-configuration-library/raw/main/bank%5Fstatements/bank%5Fof%5Famerica/boa%5Fsample.pdf) |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |

* Click your uploaded document in the left pane and verify that the extracted data updated for the new file. For example:

![Click to enlarge](/images/quickstart_llm_13.png)

### Edit extraction configuration

Behind the scenes, an _extraction configuration_ extracts data from each document using the queries, or _fields_. The fields can be powered by LLM-based prompts, or by layout-based extraction rules written in JSON. Let's take a look at LLM-based prompts.
...
![Click to enlarge](/images/quickstart_llm_3.png)
...
![Click to enlarge](/images/quickstart_llm_4.png) 
...
![Click to enlarge](/images/quickstart_llm_5.png) 
...
![Click to enlarge](/images/quickstart_llm_6.png) 

Sensible displays the auto-generated prompts and extracted data:

![Click to enlarge](/images/quickstart_llm_7.png) 
...
![Click to enlarge](/images/quickstart_llm_10.png)
...
![Click to enlarge](/images/quickstart_llm_11.png)

* Scroll down the right pane and click **Extract**. Sensible displays the extracted data:

![Click to enlarge](/images/quickstart_llm_12.png)
...
Now you've published your config, you can get document data at scale using Sensible's APIs, SDKs, or bulk-upload UI. Put the extracted data to work in Excel files, databases, and other destinations. For more inforamtion, see [Integrating](https://sensible-87.mintlify.app/welcome/integrating).

### Next: Learn more about extraction

* See [prompt authoring tips](https://sensible-87.mintlify.app/llm-based-extractions/prompt-tips/overview)
* For advanced extraction strategies, see [Choosing an extraction approach](https://sensible-87.mintlify.app/welcome/choosing-an-extraction-approach)