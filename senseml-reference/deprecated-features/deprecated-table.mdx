...
This method is deprecated. To duplicate this method's function, use the [NLP Table ](/senseml-reference/llm-methods/nlp-table) method and set the Rewrite Table parameter to false.
