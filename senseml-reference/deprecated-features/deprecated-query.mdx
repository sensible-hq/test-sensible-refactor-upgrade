...
The Query method is deprecated. The Query Group method replaces this method. See [Query Group](/senseml-reference/llm-based-methods/query-group) for more information.
...
Sensible recommends framing each query, or prompt, so that it has a single, short answer.  For prompts with multi-part answers, use the [List method](/senseml-reference/llm-based-methods/list). 
...
**Note** You can configure some the following parameters in both the [NLP](/senseml-reference/preprocessors/nlp) preprocessor and in a field's method. If you configure both, the field's parameter overrrides the NLP preprocessor's parameter. For more information, see [Advanced prompt configuration](/llm-based-extractions/prompt).
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/screenshots/question_1.png)
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/screenshots/question_2.png)
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/screenshots/question_chunk.png)
...
- Sensible creates a full prompt for the LLM (GPT-3.5 Turbo) that includes the chunks, page hinting data, and your prompt. For more information about the full prompt, see [Advanced prompt configuration](/llm-based-extractions/prompt).
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/screenshots/changelog_August2023_location.png)
