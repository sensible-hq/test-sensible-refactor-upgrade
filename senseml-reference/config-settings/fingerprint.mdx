...
| -------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| match (**required**) | a string, a [Match object](/senseml-reference/field-query-object/match), or array of Match objects. | Specifies the text to match for the test.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
For an example of using fingerprints to extract multiple documents from a portfolio file, see [Multi-document extraction](/layout-based-extractions/portfolio).

### Notes

For information about configuring fingerprint strictness for standalone documents, see [Fingerprint mode](/senseml-reference/document-type-settings/fingerprint-mode).