...
Sensible handles OCR for documents automatically, except for advanced cases. This topic covers advanced cases. For information about additional OCR options, see [OCR](/senseml-reference/concepts/ocr).
...
**Note:** Set this parameter in the [Sensible API](/api-reference/configuration/document-type/create-document-type).
