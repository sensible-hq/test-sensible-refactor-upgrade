...
For a list of methods, see [Methods](/senseml-reference/methods/index-methods). 

[**Parameters**](/senseml-reference/field-query-object/method#parameters)  
[**Examples**](/senseml-reference/field-query-object/method#examples)
...
| typeFilters                 | array of [Types](/senseml-reference/field-query-object/types)                                                                                | Filters out the specified types from the method results. For example, for a target box containing a delivery date, a street address, and delivery notes, you can filter out the lines containing Date and Address types in order to extract the delivery notes. Note that less strict types, such as Name and Currency types, are less useful in this filter than stricter types such as the Phone Number type.For an example, see the Examples section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
![Click to enlarge](/assets/v0/images/screenshots/xmajor_sort_1.png)
...
![Click to enlarge](/assets/v0/images/screenshots/sort_lines_2.png)
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_ocr_1.png)
...
![Click to enlarge](/assets/v0/images/screenshots/types_filter.png)
...
![Click to enlarge](/assets/v0/images/screenshots/xrange_filter.png)
