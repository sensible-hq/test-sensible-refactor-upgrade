...
Filter and format extracted data using the Type parameter in a [Field object](/senseml-reference/field-query-object/index-field-query-object). 
...
[Address](/senseml-reference/field-query-object/types#address)  
[Boolean](/senseml-reference/field-query-object/types#boolean)  
[Compose](/senseml-reference/field-query-object/types#compose)  
[Currency](/senseml-reference/field-query-object/types#currency)  
[Custom](/senseml-reference/field-query-object/types#custom)  
[Date](/senseml-reference/field-query-object/types#date)  
[Distance](/senseml-reference/field-query-object/types#distance)  
[Images](/senseml-reference/field-query-object/types#images)  
[Name](/senseml-reference/field-query-object/types#name)  
[Number](/senseml-reference/field-query-object/types#number)  
[Paragraph](/senseml-reference/field-query-object/types#paragraph)  
[Percentage](/senseml-reference/field-query-object/types#percentage)  
[Phone Number](/senseml-reference/field-query-object/types#phone-number)  
[String](/senseml-reference/field-query-object/types#string)  
[Table](/senseml-reference/field-query-object/types#table)  
[Weight](/senseml-reference/field-query-object/types#weight)  
[Deprecated types](/senseml-reference/field-query-object/types#deprecated-types)
...
![Click to enlarge](/assets/v0/images/screenshots/type_address_block.png)
...
![Click to enlarge](/assets/v0/images/screenshots/type_address_paragraph.png)
...
* As a more syntactically concise alternative to the [Regex](/senseml-reference/methods/regex) method or to [Computed Field methods](/senseml-reference/computed-field-methods/index-computed-field-methods). For example, you can write a field to capture a date-typed field, then transform the field's output with the [Split](/senseml-reference/computed-field-methods/split) method. Or, see the following example to transform dates using the Compose type.
* To transform table cell contents. As an alternative, see the [NLP table](/senseml-reference/llm-based-methods/nlp-table) method to transform table cell contents using large language models(LLMs).
...
![Click to enlarge](/assets/v0/images/screenshots/compose_type.png)
...
Use this solely with the [Document Range](/senseml-reference/methods/document-range) method to return image metadata.
...
Use with methods that return paragraphs, for example [Document Range](/senseml-reference/methods/document-range) or [Paragraph](/senseml-reference/methods/paragraph), to format the extracted text. By default, returns paragraphs formatted with newline characters (\\n), instead of formatted as a single string.
...
![Click to enlarge](/assets/v0/images/screenshots/annotate_superscript_and_subscript.png) 
...
Required when you define a [table method](/senseml-reference/concepts/table-methods).

## Weight

Returns pounds and kilograms. Recognizes digits in USA decimal notation (for example, 1,500.06):

* digits are in the format recognized by the [Number](/senseml-reference/field-query-object/types#number) type
...
**Deprecated**. See [Currency](/senseml-reference/field-query-object/types#currency)
