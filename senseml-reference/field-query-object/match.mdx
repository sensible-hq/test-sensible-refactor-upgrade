...
[**Match types**](/senseml-reference/field-query-object/match#match-types)

* [Global parameters](/senseml-reference/field-query-object/match#global-parameters)
* [Simple match](/senseml-reference/field-query-object/match#simple-match)
* [Regex match](/senseml-reference/field-query-object/match#regex-match)
* [First match](/senseml-reference/field-query-object/match#first-match)
* [Boolean matches](/senseml-reference/field-query-object/match#boolean-matches)

[**Match arrays**](/senseml-reference/field-query-object/match#match-arrays)
...
```
For even simpler matching syntax in anchors, you can use `"anchor":"some string to match"`. For more information see [Anchor](/senseml-reference/field-query-object/anchor).
...
![Click to enlarge](/assets/v0/images/screenshots/edit_distance.png)
...
![Click to enlarge](/assets/v0/images/screenshots/boolean_match.png)
