...
[**Parameters**](/senseml-reference/field-query-object/index#parameters)  
[**Examples**](/senseml-reference/field-query-object/index#examples)  
[**Notes**](/senseml-reference/field-query-object/index#notes)
...
| anchor (**required**) except for fields that use [LLM-based methods](/senseml-reference/llm-based-methods/index) | object                                   | The anchor identifies one or more lines of text in the document at which Sensible starts executing a method. Can be a string, Match object, or array of Match objects. For more information, see [Anchor object](/senseml-reference/field-query-object/anchor) and [Match object](/senseml-reference/field-query-object/match).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| method (**required**)                                                                         | object                                   | The method describes how Sensible expands from the anchor and extracts the target data. For more information, see [Methods](/senseml-reference/methods/index), [LLM-based methods](/senseml-reference/llm-based-methods/index), and [Method object](/senseml-reference/field-query-object/method).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
