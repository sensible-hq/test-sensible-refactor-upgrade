...
[**Match types**](/senseml-reference/field-query-object/match-object#match-types)

* [Global parameters](/senseml-reference/field-query-object/match-object#global-parameters)
* [Simple match](/senseml-reference/field-query-object/match-object#simple-match)
* [Regex match](/senseml-reference/field-query-object/match-object#regex-match)
* [First match](/senseml-reference/field-query-object/match-object#first-match)
* [Boolean matches](/senseml-reference/field-query-object/match-object#boolean-matches)

[**Match arrays**](/senseml-reference/field-query-object/match-object#match-arrays)
...
```
For even simpler matching syntax in anchors, you can use `"anchor":"some string to match"`. For more information see [Anchor](/senseml-reference/field-query-object/anchor-object).
...
You can create complex matches by using any of the preceding match types in an array. For information, see [match arrays](/senseml-reference/concepts/match-arrays).