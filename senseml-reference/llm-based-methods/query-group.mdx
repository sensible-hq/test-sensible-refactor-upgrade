...
For tips and troubleshooting, see [Query Group](/llm-based-extractions/prompt-tips/query-group-tips) extraction tips.
...
**Note:** For the full list of parameters available for this method, see [Global parameters for methods](/senseml-reference/field-query-object/method#section-global-parameters-for-methods). The following table only shows parameters most relevant to or specific to this method.

**Note** You can configure some of the following parameters in both the [NLP](/senseml-reference/preprocessors/nlp) preprocessor and in a field's method. If you configure both, the field's parameter overrides the NLP preprocessor's parameter. For more information, see [Advanced prompt configuration](/llm-based-extractions/prompt).
...
| chunkCount             | default: 5                                                                                          | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/prompt#parameters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| chunkSize              | default: 0.5                                                                                        | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/prompt#parameters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| chunkOverlapPercentage | default: 0.5                                                                                        | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/prompt#parameters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
![Click to enlarge](/assets/v0/images/screenshots/multimodal_photo.png)
...
The following example shows using a multimodal LLM to extract from a scanned document containing handwriting. For an alternate approach to extracting from this document, see also the [Sort Lines](/senseml-reference/field-query-object/method#sort-lines-example) example.
...
![Click to enlarge](/assets/v0/images/screenshots/multimodal.png)
...
![Click to enlarge](/assets/v0/images/screenshots/question_2.png)
...
* Sensible creates a full prompt for the LLM (GPT-3.5 Turbo) that includes the chunks, page hinting data, and your Description parameters. For more information about the full prompt, see [Advanced prompt configuration](/llm-based-extractions/prompt).
...
![Click to enlarge](/assets/v0/images/screenshots/location.png)
