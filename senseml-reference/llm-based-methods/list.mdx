...
For tips on authoring this method in Sensible Instruct, see [List tips](/llm-based-extractions/prompt-tips/list-tips).
...
* For highly complex repeating layouts, such as insurance loss run documents, use the [Sections](/senseml-reference/sections/overview) method.

**How it works**

For more information about how this method works, see [Notes](/senseml-reference/llm-based-methods/nlp-table#notes).

[**Parameters**](/senseml-reference/llm-based-methods/list#parameters)  
[**Examples**](/senseml-reference/llm-based-methods/list#examples)  
[**Notes**](/senseml-reference/llm-based-methods/list#notes)
...
| chunkCount                          | 20                                                                                                  | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration#parameters)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| chunkSize                           | 1                                                                                                   | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration#parameters)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| chunkOverlapPercentage              | 0                                                                                                   | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration#parameters)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
