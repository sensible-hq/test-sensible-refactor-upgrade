...
For tips on authoring this method in Sensible Instruct, see [NLP Table tips](/llm-based-extractions/prompt-tips/nlp-table-extraction-tips).
...
* Doesn't require an [anchor](/senseml-reference/field-query-object/anchor-object).

**Limitations**

* Can have a moderate impact on performance. For more information, see [Optimizing extraction performance](/best-practices/tutorials/optimizing-extraction-performance).
...
For more information about how this method works, see [Notes ](/senseml-reference/llm-based-methods/nlp-table#notes).

[**Parameters**](/senseml-reference/llm-based-methods/nlp-table#parameters)  
[**Examples**](/senseml-reference/llm-based-methods/nlp-table#examples)  
[**Notes**](/senseml-reference/llm-based-methods/nlp-table#notes)
