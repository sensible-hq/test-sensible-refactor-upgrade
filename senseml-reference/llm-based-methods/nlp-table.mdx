...
For tips on authoring this method in Sensible Instruct, see [NLP Table tips](/llm-based-extractions/prompt-tips/table-tips).
...
* Doesn't require an [anchor](/senseml-reference/field-query-object/anchor).

**Limitations**

* Can have a moderate impact on performance. For more information, see [Optimizing extraction performance](/best-practices/tutorials/performance).
...
| (**Deprecated**) promptIntroduction | string.                                                                                             | **(Deprecated)** overwrites the introductory text at the beginning of the [full prompt](/llm-based-extractions/prompt) that Sensible submits to the LLM for this field.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
![Click to enlarge](/assets/v0/images/screenshots/nlp_table.png)
