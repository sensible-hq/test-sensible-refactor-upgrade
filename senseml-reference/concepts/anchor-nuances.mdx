...
**Note:** If you're familiar with Sensible, this detailed topic is for you. If you're new to Sensible, see [anchor](/senseml-reference/field-query-object/anchor-object).

[anchor syntax](/senseml-reference/field-query-object/anchor-object-nuances#anchor-syntax)

[methods-filter-anchors](/senseml-reference/field-query-object/anchor-object-nuances#methods-filter-anchors)
