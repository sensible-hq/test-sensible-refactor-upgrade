...
**Note:** If you're familiar with extraction coverage, this detailed topic is for you. If you're new to Sensible, see [Monitoring extractions](/best-practices/monitoring-extractions).
...
* `validation penalties` \= sum of [validation](/best-practices/validating-extractions) errors and warnings. Errors are 1 penalty point and warnings are 0.5 points.
...
* Sensible includes fields output in [sections](/senseml-reference/sections/overview) when calculating the coverage.
