...
**Note:** If you're familiar with Sensible, this detailed topic is for you. If you're new to Sensible, see [match](/senseml-reference/field-query-object/match).
...
* The matches specified in the array occur in the document in the same order as in the array. For more information about line ordering, see [Lines](/senseml-reference/concepts/lines).
...
![Click to enlarge](/assets/v0/images/final/reverse_1.png)
...
![Click to enlarge](/assets/v0/images/final/reverse_2.png)