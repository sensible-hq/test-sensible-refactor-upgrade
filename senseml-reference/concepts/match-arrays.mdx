...
**Note:** If you're familiar with Sensible, this detailed topic is for you. If you're new to Sensible, see [match](/senseml-reference/field-query-object/match-object).
