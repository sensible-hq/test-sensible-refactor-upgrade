...
**Note:** If you're familiar with Sensible, this detailed topic is for you. If you're new to Sensible, see [sections](/senseml-reference/sections/index-sections).

The following images show the differing behaviors of sections and vertical sections:

### Sections

![Click to enlarge](/assets/v0/images/final/sections_concept_horizontal.png)
...
![Click to enlarge](/assets/v0/images/final/sections_concept_vertical.png)
...
![Click to enlarge](/assets/v0/images/final/vertical_section_column_selection.png)
...
For more information about this example, see [Labeled rows and labeled columns table example](/senseml-reference/sections/sections-example-labeled-rows)
...
![Click to enlarge](/assets/v0/images/final/sections_match_all_anchors.png)
