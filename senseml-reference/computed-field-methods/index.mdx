...
Computed Field methods transform the output of one or more [Field objects](/senseml-reference/field-query-object/index). Common use cases for computed fields include:
...
| type                  | string (default: string) | Specifies the type of the output value. For more information about types, see [Field query object](/senseml-reference/field-query-object/index).                                                                                                                                                                                                                                                                                                                                                                   |

### Notes

See also [Advanced computed field methods](/senseml-reference/advanced-computed-field-methods/index).