...
* Zips the output of a single [table method](/senseml-reference/concepts/choosing-a-table-method) into row objects. Or, use this to zip multiple tables together.
* Zips the output of [sections](/senseml-reference/sections/overview) into an array of objects.
...
For an example of zipping sections together, see [Zip sections example](/senseml-reference/sections/advanced--zip-sections).
