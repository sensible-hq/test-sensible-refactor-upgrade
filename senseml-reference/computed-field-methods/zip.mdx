...
* Zips the output of a single [table method](/senseml-reference/concepts/table-methods) into row objects. Or, use this to zip multiple tables together.
* Zips the output of [sections](/senseml-reference/sections/index) into an array of objects.
...
For an example of zipping sections together, see [Zip sections example](/senseml-reference/sections/sections-example-zip).
