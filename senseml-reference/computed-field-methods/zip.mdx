...
* Zips the output of [sections](/senseml-reference/sections/index-sections) into an array of objects.
...
![Click to enlarge](/assets/v0/images/final/zip.png)
...
![Click to enlarge](/assets/v0/images/final/all_with_null.png)
