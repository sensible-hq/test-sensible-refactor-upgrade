...
To configure a page range on a field-by-field basis for Sensible Instruct methods, see the [Page Range parameter](/llm-based-extractions/advanced-prompt-configuration).
