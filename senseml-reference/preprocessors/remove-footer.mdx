...
| match               | [Match](/senseml-reference/field-query-object/match-object) object or array of Match objects | Bypasses automatic footer recognition.Removes all text on the page below the bottom boundary of the matched line.If Sensible doesn't find the match, it doesn't perform footer removal.                                                                                                                                             |
