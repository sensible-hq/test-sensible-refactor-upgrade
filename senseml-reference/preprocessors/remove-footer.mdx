...
* (Default) Sensible searches for repeated text at the bottom of the page. For more information about automatic recognition, see [Notes](/senseml-reference/preprocessors/remove-footer#notes).
...
| match               | [Match](/senseml-reference/field-query-object/match) object or array of Match objects | Bypasses automatic footer recognition.Removes all text on the page below the bottom boundary of the matched line.If Sensible doesn't find the match, it doesn't perform footer removal.                                                                                                                                             |
...
![Click to enlarge](/assets/v0/images/screenshots/remove_footer_1.png)

![Click to enlarge](/assets/v0/images/screenshots/remove_footer_2.png)
