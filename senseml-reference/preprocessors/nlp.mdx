...
Configures the full prompt for all [Sensible Instruct](/llm-based-extractions/prompt-tips/overview) methods in a config. For information about configuring the full prompt, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration).
...
| (**Deprecated**) query | object                                                                                              | For information about this deprecated parameter see [Query](/senseml-reference/field-query-object/overview).                                                                                                                                                 |
...
| chunkCount             | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration#parameters). |                                                                                                                                                                                                                                      |
| chunkSize              | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration#parameters). |                                                                                                                                                                                                                                      |
| chunkOverlapPercentage | For information about this parameter, see [Advanced prompt configuration](/llm-based-extractions/advanced-prompt-configuration#parameters). |                                                                                                                                                                                                                                      |
