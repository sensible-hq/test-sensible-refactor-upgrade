...
Configures the full prompt for all [Sensible Instruct](/llm-based-extractions/prompt-tips/index) methods in a config. For information about configuring the full prompt, see [Advanced prompt configuration](/llm-based-extractions/prompt).
...
| (**Deprecated**) query | object                                                                                              | For information about this deprecated parameter see [Query](/senseml-reference/field-query-object/index).                                                                                                                                                 |
