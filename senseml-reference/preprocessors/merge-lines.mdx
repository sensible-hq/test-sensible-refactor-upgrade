...
[**Parameters**](/senseml-reference/preprocessors/merge-lines#parameters)  
[**Examples**](/senseml-reference/preprocessors/merge-lines#examples)  
[**Notes**](/senseml-reference/preprocessors/merge-lines#notes)
...
| adjacentThreshold (**required**)         | number >= 0.6                           | Corrects oversplit lines. Specifies the fraction of line height under which to merge two adjacent lines distributed along an x-axis _with_ a space. The built-in merger uses 0.6, so choosing a larger number merges more aggressively. For an example, see the Examples section.                                                                                                                                                                                                                                                                 |
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_ocr_2.png)
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_ocr.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/merge%5Flines%5Focr.pdf) |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_oversplit_1.png)
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_oversplit_2.png)
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_yoverlap.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/merge%5Flines%5Fyoverlap.pdf) |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
...
![Click to enlarge](/assets/v0/images/screenshots/merge_lines_minxgap.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/merge%5Flines%5Fminxgap.pdf) |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
