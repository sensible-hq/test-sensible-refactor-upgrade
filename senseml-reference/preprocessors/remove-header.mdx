...
* (Default) Sensible searches for repeated text at the top of the page. For more information about automatic recognition, see [Notes](/senseml-reference/preprocessors/remove-header#notes).
...
| match               | [Match](/senseml-reference/field-query-object/match) object or array of Match objects | Bypasses automatic header recognition.Removes all text on the page above the top boundary of the matched line.If Sensible doesn't find the match, it doesn't perform header removal.                                                                                                                                          |
...
![Click to enlarge](/assets/v0/images/screenshots/remove_header_1.png)

![Click to enlarge](/assets/v0/images/screenshots/remove_header_2.png)
