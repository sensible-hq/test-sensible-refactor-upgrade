...
| match               | [Match](/senseml-reference/field-query-object/match-object) object or array of Match objects | Bypasses automatic header recognition.Removes all text on the page above the top boundary of the matched line.If Sensible doesn't find the match, it doesn't perform header removal.                                                                                                                                          |
