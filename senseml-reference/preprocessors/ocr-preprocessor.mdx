...
When you [extract document data with Sensible](/welcome/getting-started-ai), Sensible automatically OCRs the document for you, except in advanced cases. This topic covers advanced cases. For information about additional OCR options, see [OCR](/senseml-reference/concepts/ocr).
...
| engine                                                             | See [OCR engine](/senseml-reference/document-type-settings/ocr-engine). |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
