...
In the following screenshot, the green brackets denote sections, where each section is a claim. The orange brackets denote an external range. The labels for the claims' content is at the start of the document, under the `Claims contents` heading. The example defines an external range for these labels, then uses the [Intersection](/senseml-reference/methods/intersection) method to specify vertical anchors in the external range.
...
![Click to enlarge](/assets/v0/images/final/sections_external_range.png)
...
![Click to enlarge](/assets/v0/images/final/sections_external_range_dynamic.png)
