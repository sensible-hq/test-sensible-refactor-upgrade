...
![Click to enlarge](/assets/v0/images/screenshots/copy_from_sections_2.png)

If you [zip the child sections together](/senseml-reference/sections/sections-example-zip), you can output something like the following example output, and then clean it up with the Copy From Sections method. 
...
![Click to enlarge](/assets/v0/images/screenshots/copy_from_sections.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/copy%5Ffrom%5Fsections.pdf) |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
