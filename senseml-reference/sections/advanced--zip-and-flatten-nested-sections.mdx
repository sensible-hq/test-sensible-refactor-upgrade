...
If you [zip the child sections together](/senseml-reference/sections/advanced--zip-sections), you can output something like the following example output, and then clean it up with the Copy From Sections method. 
