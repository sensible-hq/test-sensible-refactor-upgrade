...
* Ignoring repeated multiple anchor matches. For more information, see [Multiple anchors in section](/senseml-reference/concepts/section-nuances#multiple-anchors-in-section).

### Overview

To give a broad overview of using vertical sections for a table grid, see the following image:

![Click to enlarge](/assets/v0/images/screenshots/vertical_sections_table_grid.png)
...
![Click to enlarge](/assets/v0/images/screenshots/vertical_section_table_grid_1.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/pdfs/vertical%5Fsections%5Ftable%5Fgrid.pdf) |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
