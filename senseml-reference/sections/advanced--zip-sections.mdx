...
* Using SenseML execution order to output the zipped section group and suppress the source section groups. See [Field extraction order](/senseml-reference/concepts/field-extraction-order).
