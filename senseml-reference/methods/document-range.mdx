...
| stop              | [Match object](/senseml-reference/field-query-object/match) or array of Match objects. default: none | Stops extraction at the top boundary of the matched line. The matched line isn't included in the method output. If unspecified, matches to the end of the document.                                                                                                                                                                                                                                                               |
...
![Click to enlarge](/assets/v0/images/screenshots/documentrange_sworn.png)
...
![Click to enlarge](/assets/v0/images/screenshots/documentrange_icons.png)
...
![Click to enlarge](/assets/v0/images/screenshots/document_range_yoffset.png)
