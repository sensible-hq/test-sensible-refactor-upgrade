...
[**Parameters**](/senseml-reference/methods/region#parameters)  
[**Examples**](/senseml-reference/methods/region#examples)  
[**Notes**](/senseml-reference/methods/region#notes)
...
If the region that you want to extract is a box that's bordered with dark lines, you can use the [Box method](/senseml-reference/methods/box) instead of the Region method.