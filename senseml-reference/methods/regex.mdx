...
[**Parameters**](/senseml-reference/methods/regex#parameters)  
[**Examples**](/senseml-reference/methods/regex#examples)  
[**Notes**](/senseml-reference/methods/regex#notes)
...
Alternatives to this method include the [Passthrough method](/senseml-reference/methods/passthrough) with a custom type. For example, for the preceding example document, the following config returns similar output:
