...
| source\_id (**required**) | source field ID in the current config                    | The ID of the table you want to transform. To transform fields in a section, add a [computed fields array to sections](/senseml-reference/sections/sections-example-copy-to-section).                                                                                                   |
| fields                    | array of [computed fields](/senseml-reference/computed-field-methods/index-computed-field-methods) | Specifies to output computed fields in the new table. The computed fields have access to the source table's fields. To get access to and transform the output of fields that aren't in the source table, use the [Copy to section](/senseml-reference/advanced-computed-field-methods/copy-to-section) method. |
...
![Click to enlarge](/assets/v0/images/final/add_computed_fields_3.png)
...
![Click to enlarge](/assets/v0/images/final/add_computed_fields_2.png)
