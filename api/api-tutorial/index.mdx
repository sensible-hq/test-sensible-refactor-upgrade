...
* [Try synchronous extraction](/api/api-tutorial/api-tutorial-async-2)
* [Try asynchronous extraction](/api/api-tutorial/api-tutorial-async-1)
* [Try a webhook](/api/api-tutorial/api-tutorial-webhook)