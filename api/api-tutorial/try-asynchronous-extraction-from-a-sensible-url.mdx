...
For either option, you can get the results as soon as they're ready by specifying a [webhook](/api/api-tutorial/try-a-webhook).

## Extract from a URL Sensible provides

### Prerequisites

See [prerequisites](/api/api-tutorial/overview#prerequisites).
...
* Use a webhook. See [Try a webhook](/api/api-tutorial/try-a-webhook).
