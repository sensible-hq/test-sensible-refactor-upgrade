...
For either option, you can get the results as soon as they're ready by specifying a [webhook](/api/api-tutorial/api-tutorial-webhook).

## Extract from a URL Sensible provides

### Prerequisites

See [prerequisites](/api/api-tutorial/index#prerequisites).
...
* Use a webhook. See [Try a webhook](/api/api-tutorial/api-tutorial-webhook).
