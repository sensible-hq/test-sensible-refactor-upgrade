...
* see the [API quickstart](/integrations/api-quickstart) to get a sample API response.
...
* [Try synchronous extraction](/api/api-tutorial/try-asynchronous-extraction-from-a-sensible-url)
* [Try asynchronous extraction](/api/api-tutorial/try-asynchronous-extraction-from-your-url)
* [Try a webhook](/api/api-tutorial/try-a-webhook)