                ...
                for (const { source, reason, ruleId, fatal, line, column, place, } of messages) {
                    ...
                    context.report({
                        ...
                        loc: place && 'start' in place
                            ? Object.assign(Object.assign({}, point), { start: Object.assign(Object.assign({}, place.start), { column: place.start.column - 1 }), end: Object.assign(Object.assign({}, place.end), { column: place.end.column - 1 }) }) : point,
                        node,
