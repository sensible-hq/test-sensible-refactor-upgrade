...
* For more information about how to write descriptions, or "prompts", see [Query Group](/llm-based-extractions/prompt-tips/query-group-tips).
...
![Click to enlarge](/assets/v0/images/final/quickstart_instruct_4.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_instruct_5.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_instruct_6.png)
...
![Click to enlarge](/assets/v0/images/final/quickstart_instruct_7.png)

### Example 2

The following example shows using the NLP Table method to extract data from an auto insurance document:

![Click to enlarge](/assets/v0/images/final/nlp_table_instruct.png)
...
![Click to enlarge](/assets/v0/images/final/nlp_table_instruct_2.png)
