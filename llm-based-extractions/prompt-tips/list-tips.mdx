...
* You can use location hints to describe the target list's position in the document. For examples of location hints, see [Query Group](/llm-based-extractions/prompt-tips/query-group-extraction-tips) extraction tips.
* For more information about how to write descriptions, or "prompts", see [Query Group](/llm-based-extractions/prompt-tips/query-group-extraction-tips) extraction tips.
