...
![Click to enlarge](/assets/v0/images/final/api_quickstart_postman_3.png)
...
![Click to enlarge](/assets/v0/images/final/api_quickstart_postman_4.png)
...
![Click to enlarge](/assets/v0/images/final/api_quickstart_no_auth.png)
...
![Click to enlarge](/assets/v0/images/final/api_quickstart_postman_headers_2.png)
...
![Click to enlarge](/assets/v0/images/final/api_quickstart_postman_file.png)

5. Click **Send** to send the request. The response is `200`:

![Click to enlarge](/assets/v0/images/final/api_quickstart_postman_200.png) 
...
![Click to enlarge](/assets/v0/images/final/api_quickstart_postman_2.png)
